    ...
    if(searchText === ''){
      ...
      this.filterUser = this.users.filter((user)=>{
        return (user.name.toLowerCase().includes(searchText.toLowerCase()) ||
         (user.email != undefined && user.email.toLowerCase().includes(searchText.toLowerCase()) ) ||
